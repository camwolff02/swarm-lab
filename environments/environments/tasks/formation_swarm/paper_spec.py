...
CURRICULUM_DELAYED_THROW_THRESHOLD_STEPS = 1000
CURRICULUM_DELAYED_THROW_TIME_RANGE_STEPS = 800
...
HAS_OBSTACLE_COEFF = 0.2
NO_OBSTACLE_COEFF = 1.0
AFTER_THROW_COEFF = 0.2
