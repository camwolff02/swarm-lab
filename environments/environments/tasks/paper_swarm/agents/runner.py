...
def _generate_models(env: Any, cfg: dict[str, Any]) -> dict[str, dict[str, Model]]:
    ...
    shared_value = PaperDeterministicValue(
        env.state_spaces.get(first_agent) or env.observation_spaces[first_agent],
        env.action_spaces[first_agent],
        device,
...
def _generate_shared_mappo_agent(self: Runner, env: Any, cfg: dict[str, Any], models: dict[str, dict[str, Model]]) -> PaperSharedMAPPO:
